...
function config.vim_visual_multi()
  ...
  vim.g.VM_maps = {
    ['Find Under'] = '<C-n>', -- 选中光标下的词(ctrl+n继续向下选中相同文本)
    ['Find Subword Under'] = '<C-n>', -- 选中光标下的词(ctrl+n继续向下选中相同文本)
    ['Select All'] = 'gb', -- 选中文件中所有光标下的词
    ['Select h'] = '<C-Left>', -- 从光标往左选中文本(ctrl+n继续向下选中相同文本)
    ['Select l'] = '<C-Right>', -- 从光标往右选中文本(ctrl+n继续向下选中相同文本)
    ['Add Cursor Up'] = '<M-k>', -- 向上添加一个光标(原光标+上光标 继续使用则继续添加)
    ['Add Cursor Down'] = '<M-j>', -- 向下添加一个光标(原光标+下光标 继续使用则继续添加)
    ['Add Cursor At Pos'] = '<C-x>', -- 将当前光标添加入多光标列表中}
    ['Add Cursor At Word'] = '<C-w>', -- 将当前光标所在词的词首加上多光标列表中
    ['Move Left'] = '<C-S-Left>',
