...
keymap('n', '<leader>bd', '<cmd>BufferLinePickClose<cr>')
keymap('n', '<leader>b1', '<cmd>lua require("bufferline").go_to_buffer(1, true)<cr>')
keymap('n', '<leader>b2', '<cmd>lua require("bufferline").go_to_buffer(2, true)<cr>')
keymap('n', '<leader>b3', '<cmd>lua require("bufferline").go_to_buffer(3, true)<cr>')
keymap('n', '<leader>b4', '<cmd>lua require("bufferline").go_to_buffer(4, true)<cr>')
keymap('n', '<leader>b5', '<cmd>lua require("bufferline").go_to_buffer(5, true)<cr>')
keymap('n', '<leader>b6', '<cmd>lua require("bufferline").go_to_buffer(6, true)<cr>')
keymap('n', '<leader>b7', '<cmd>lua require("bufferline").go_to_buffer(7, true)<cr>')
keymap('n', '<leader>b8', '<cmd>lua require("bufferline").go_to_buffer(8, true)<cr>')
keymap('n', '<leader>b9', '<cmd>lua require("bufferline").go_to_buffer(9, true)<cr>')
