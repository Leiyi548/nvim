...
keymap('n', '<C-w>1', '<cmd>lua require("bufferline").go_to_buffer(1, true)<cr>')
keymap('n', '<C-w>2', '<cmd>lua require("bufferline").go_to_buffer(2, true)<cr>')
keymap('n', '<C-w>3', '<cmd>lua require("bufferline").go_to_buffer(3, true)<cr>')
keymap('n', '<C-w>4', '<cmd>lua require("bufferline").go_to_buffer(4, true)<cr>')
keymap('n', '<C-w>5', '<cmd>lua require("bufferline").go_to_buffer(5, true)<cr>')
keymap('n', '<C-w>6', '<cmd>lua require("bufferline").go_to_buffer(6, true)<cr>')
keymap('n', '<C-w>7', '<cmd>lua require("bufferline").go_to_buffer(7, true)<cr>')
keymap('n', '<C-w>8', '<cmd>lua require("bufferline").go_to_buffer(8, true)<cr>')
keymap('n', '<C-w>9', '<cmd>lua require("bufferline").go_to_buffer(9, true)<cr>')
