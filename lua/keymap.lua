...
vim.keymap.set("i", "<C-p>", "<cmd>Telescope find_files<cr>")
vim.keymap.set("v", "<C-p>", "<cmd>Telescope find_files<cr>")
vim.keymap.set("n", "<C-b>", "<cmd>Telescope buffers<cr>")
vim.keymap.set("i", "<C-b>", "<cmd>Telescope buffers<cr>")
vim.keymap.set("v", "<C-b>", "<cmd>Telescope buffers<cr>")
vim.keymap.set("n", "<leader>ft", "<cmd>Telescope live_grep<cr>")
vim.keymap.set("n", "<leader>fT", "<cmd>lua require('config.fancy_telescope').grep_string_by_filetype()<cr>")
vim.keymap.set("n", "<leader>fo", "<cmd>lua require('config.fancy_telescope').grep_string_open_files()<cr>")
