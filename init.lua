_G_colorscheme = 'catppuccin' -- github_light github_dark onedarker catppuccin horizon zephyr rose-pine synthwave84 kanagawa gruvbox-baby gruvbox-material catppuccin
require('core')
-- textobject
