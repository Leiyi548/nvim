_G_colorscheme = 'kanagawa' -- github_light github_dark onedarker catppuccin horizon zephyr rose-pine synthwave84 kanagawa gruvbox-baby gruvbox-material catppuccin gruvbox
require('core')
-- textobject
